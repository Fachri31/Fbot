  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    ...
	    {title: `💌 ${pmenus} OWNER`, rowId: ".owner", description: "Menampilkan Fitur/List owner👤 "},
	...
	title: `┄┄┄┄┅┅| SUPPORT👍 |┅┅┄┄┄┄`,
	rows: [
	    {title: `🔖 ${pmenus} Sewa Bot`, rowId: ".sewa", description: "Menampilkan list harga sewa FazhBoT🤖"},
	    {title: `🌟 ${pmenus} Upgrade Premium`, rowId: ".premium", description: "Menampilkan list harga upgrade premium🥀"},
	    {title: `💰 ${pmenus} Donasi`, rowId: ".donasi", description: 'Support BOT agar on 1 Minggu non stop❣️'},
	{title: `✨ ${pmenus} Rate`, rowId: ".rate", description: 'Support BOT agar Semangat update🌴'},
	]
	},{
	title: `┄┄┄┄┅┅| MENU🔥 |┅┅┄┄┄┄`,
	rows: [
	    {title: `💬 ${pmenus} All`, rowId: ".? all", description: "Menampilkan Semua Fitur BOT🤖"},
